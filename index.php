...
<body>
                ...
                <form action="proses.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kategori" id="">
                            ...
                            <option value="Mumah Sakit">Rumah Sakit</option>
    ...
    <script>
        var mymap = L.map('mapid').setView([-7.007602, 113.859468], 13);
        ...
        while ($row = $result->fetch()) {
            ...
            $popupData = 'nama tempat: ' . $row['nama_tempat'] . ' |kategori: ' . $row['kategori'];
